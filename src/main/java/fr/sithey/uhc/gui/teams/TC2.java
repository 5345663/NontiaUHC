...
public class TC2 implements CustomInventory {

    private Main main = Main.getInstance();

    @Override
    public String getName() {
        return "§6Teams §8(page 2)";
    }
    ...
    public Supplier<ItemStack[]> getContents(Player player) {
        ...
        slots [47] = new ItemCreator(Material.REDSTONE).setName("§8Page 1").getItem();
        slots [51] = new ItemCreator(Material.EMERALD).setName("§8Page 3").getItem();
